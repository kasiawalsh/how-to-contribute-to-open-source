...
- ["Getting Started with Open Source" by NumFocus](https://github.com/numfocus/getting-started-with-open-source) - repozytorium na GitHubie autorstwa NumFocus, które pomaga kontrybutorom pokonać bariery wejścia w świat otwartego oprogramowania.
- ["Opensource-4-everyone" by Chryz-hub](https://github.com/chryz-hub/opensource-4-everyone) - repozytorium autorstwa Chryz-hub zawierające wszystko, co związane jest z otwartym oprogramowaniem. Projekt ma na celu pomoc w zwiększeniu widoczności członkostwa na GitHubie, ćwiczeniu podstawowych i zaawansowanych komend gita, rozpoczęciu pracy z open source i nie tylko.
- ["Open Advice"](http://open-advice.org/) - zbiór wiedzy pochodzący z różnorodnych projektów wolnego oprogramowania. Odpowiada na pytanie, co 42 znanych kontrybutorów chciałoby wiedzieć na początku swojej drogi, aby ułatwić Ci start – niezależnie od tego, jak i gdzie kontrybuujesz.
- ["GitHub Skills"](https://skills.github.com/) - rozwijaj swoje umiejętności z GitHub Skills. Nasz przyjazny bot poprowadzi Cię przez serię ciekawych i praktycznych projektów, dzięki którym szybko nauczysz się potrzebnych umiejętności – a po drodze otrzymasz pomocne wskazówki i informacje zwrotne.
- ["Ten simple rules for helping newcomers become contributors to open projects"](https://doi.org/10.1371/journal.pcbi.1007296) - "Dziesięć prostych zasad, które pomagają nowicjuszom zostać kontrybutorami do otwartych projektów" - Artykuł przedstawiający zasady oparte na badaniach wielu społeczności oraz na doświadczeniach ich członków, liderów i obserwatorów.
- ["Step-by-Step guide to contributing on GitHub"](https://www.dataschool.io/how-to-contribute-on-github/) - szczegółowy przewodnik ze wsparciem wizualnym i linkami, obejmujący cały proces wnoszenia wkładu do projektu open source.
- [Open Source with Pradumna](https://github.com/Pradumnasaraf/open-source-with-pradumna) - to repozytorium zawiera materiały i zasoby, które pomogą nauczyć się i zacząć pracę z Open Source, Git oraz GitHub.
- ["FOSS Community Acronyms"](https://github.com/d-edge/foss-acronyms) - repozytorium zawierające listę skrótów używanych w społeczności FOSS (ang. Free and Open Source Software), wraz z ich definicjami i zastosowaniami.
...
- [Learn Git and GitHub Step By Step (on Windows)](https://medium.com/illumination/path-to-learning-git-and-github-be93518e06dc) by [@ows-ali](https://medium.com/@ows_ali) - Nauka Gita i GitHuba krok po kroku (na Windows) autorstwa [@ows-ali](https://medium.com/@ows_ali).
...
- [What open-source should I contribute to](https://kentcdodds.com/blog/what-open-source-project-should-i-contribute-to) by [@kentcdodds](https://twitter.com/kentcdodds) - Do jakiego projektu open source powinienem wnieść wkład? — autor: [@kentcdodds](https://twitter.com/kentcdodds).
